...
}, $fz.isPrivate = true, $fz), "JSV.common.Coordinate,JSV.common.Coordinate,JSV.common.XYScaleConverter,~N");
$_M(c$, "setReversePlot", 
function (val) {
...
$_M(c$, "drawSpectrum", 
($fz = function (g, index, yOffset, isGrey, ig, isContinuous, isSelected) {
...
}, $fz.isPrivate = true, $fz), "~O,~N,~N,~B,JSV.common.IntegralData,~B,~B");
...
$_M(c$, "drawPlot", 
($fz = function (g, index, spec, isContinuous, yOffset, isGrey, ig, isSelected) {
...
}}}, $fz.isPrivate = true, $fz), "~O,~N,JSV.common.Spectrum,~B,~N,~B,JSV.common.IntegralData,~B");
$_M(c$, "drawFrame", 
...
this.mapX.clear ();
}, $fz.isPrivate = true, $fz), "~O,JSV.common.XYScaleConverter");
$_M(c$, "drawTick", 
($fz = function (g, x, y1, y2, c) {
if (x == c.fixX (x)) this.g2d.drawLine (g, x, y1, x, y2);
}, $fz.isPrivate = true, $fz), "~O,~N,~N,~N,JSV.common.XYScaleConverter");
$_M(c$, "drawYScale", 
($fz = function (g, c) {
var sd = c.getScale ();
