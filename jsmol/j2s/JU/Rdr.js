...
c$.getCifParser = $_M(c$, "getCifParser", 
function () {
...
c$.getLimitedStreamBytes = $_M(c$, "getLimitedStreamBytes", 
function (is, n) {
...
c$.StreamToUTF8String = $_M(c$, "StreamToUTF8String", 
function (bis) {
...
c$.readAllAsString = $_M(c$, "readAllAsString", 
...
c$.getPngZipPointAndCount = $_M(c$, "getPngZipPointAndCount", 
...
c$.getPngZipStream = $_M(c$, "getPngZipStream", 
