...
if (type == 'I') o = Integer.$valueOf (this.parseIntStr (v));
 else o = Double.$valueOf (Double.parseDouble (v));
...
if (iBond == null) return;
var rBond = this.fileData.get ("RBond");
var mxBond = (this.fileData.get ("MxBond")).intValue ();
...
var mult = (this.fileData.get ("Multiplicity")).intValue ();
