...
return f;
}, $fz.isPrivate = true, $fz), "~N,~N,~N,J.jvxl.readers.IsoSolventReader.Edge,JU.P3");
$_M(c$, "markFaceVoxels", 
...
return true;
}, $fz.isPrivate = true, $fz), "J.jvxl.readers.IsoSolventReader.Edge,~N,~N,~N");
$_M(c$, "checkSpecialVoxel", 
($fz = function (ptA, ptB, ptV) {
...
($fz = function (rAS, rAS2, rBS2, dAV, dAV2, dBV2) {
